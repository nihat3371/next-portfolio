...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      <div className="rounded-full absolute border-[#333333]  h-[200px] w-[200px] mt-52  animate-ping" />
      ...
      <div className="rounded-full border border-[#40E0D0] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse " />
